    ...
    <div class="bg-white rounded-3xl shadow-xl overflow-hidden mb-10">
        <div class="flex flex-col items-center justify-center p-8">
            ...
            <div class="flex items-center text-xl text-gray-600 mb-6">
                ...
                <span class="font-semibold">{{ $book->author ?? 'Tidak Diketahui' }}</span>
            </div>
                    ...
                    <div class="bg-white rounded-3xl shadow-lg card-hover overflow-hidden">
                        ...
                        <div class="p-6 pt-2">
                            ...
                            <div class="flex gap-3">
                                <a href="{{ route('books.detail', $relatedBook) }}" 
                                   class="flex-1 inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl font-semibold hover:from-green-600 hover:to-green-700 transition-all duration-300 text-sm">
